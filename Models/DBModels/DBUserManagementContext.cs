...
////            #region HVAC Loop Setting
////            modelBuilder.Entity<tbl_hvac_loop_setting>()
////                .HasOne(x => x.sensor)
////                .WithMany(x => x.hvac_loop_settings)
////                .HasForeignKey(x => x.fk_sensor)
////                .OnDelete(DeleteBehavior.Restrict);
...
////            // loop_started_at is an exact moment when the loop starts, so store it as UTC.
////            modelBuilder.Entity<tbl_hvac_loop_setting>()
////                .Property(x => x.loop_started_at)
...
////            #region appliance
////            modelBuilder.Entity<tbl_appliance>()
////    .HasOne(x => x.utility)
////    .WithMany(x => x.appliances)
////    .HasForeignKey(x => x.fk_utility)
////    .OnDelete(DeleteBehavior.Restrict);
////            modelBuilder.Entity<tbl_appliance>()
////    .Property(x => x.created_at)
////    .HasColumnType("timestamp without time zone");
...
////            #region business appliance
////            modelBuilder.Entity<tbl_business_appliance>()
////                .HasOne(x => x.business)
////                .WithMany(x => x.business_appliances)
////                .HasForeignKey(x => x.fk_business)
////                .OnDelete(DeleteBehavior.Restrict);

////            modelBuilder.Entity<tbl_business_appliance>()
////                .HasOne(x => x.default_appliance)
////                .WithMany(x => x.business_appliances)
////                .HasForeignKey(x => x.fk_appliance)
////                .OnDelete(DeleteBehavior.Restrict);
...
////            #region sensor appliance
////            modelBuilder.Entity<tbl_sensor_appliance>()
////                .HasOne(x => x.sensor)
////                .WithMany(x => x.sensor_appliances)
////                .HasForeignKey(x => x.fk_sensor)
////                .OnDelete(DeleteBehavior.Restrict);

////            modelBuilder.Entity<tbl_sensor_appliance>()
////                .HasOne(x => x.appliance)
////                .WithMany(x => x.sensor_appliances)
////                .HasForeignKey(x => x.fk_appliance)
////                .OnDelete(DeleteBehavior.Restrict);
////            modelBuilder.Entity<tbl_sensor_appliance>()
////    .Property(x => x.assigned_at)
////    .HasColumnType("timestamp without time zone");
...
////        public DbSet<tbl_appliance> tbl_appliance { get; set; }
////        public DbSet<tbl_business_appliance> tbl_business_appliance { get; set; }
////        public DbSet<tbl_sensor_appliance> tbl_sensor_appliance { get; set; }
////        public DbSet<tbl_hvac_loop_setting> tbl_hvac_loop_setting { get; set; }
////        public DbSet<tbl_business_dashboard_setting> tbl_business_dashboard_setting { get; set; }
////        public DbSet<tbl_dashboard_aggregate> tbl_dashboard_aggregate { get; set; }
////        public DbSet<tbl_dashboard_chart_aggregate> tbl_dashboard_chart_aggregate { get; set; }
////        public DbSet<tbl_dashboard_suggestion> tbl_dashboard_suggestion { get; set; }
...
namespace EMO.Models.DBModels
{
    ...
    .HasColumnType("timestamp without time zone");
            ...
            #region Sensor 15-Minute Energy Aggregate
            modelBuilder.Entity<tbl_sensor_energy_15min>(entity =>
            {
                entity.ToTable("tbl_sensor_energy_15min");

                entity.HasKey(x => new { x.fk_sensor, x.bucket_start })
                    .HasName("pk_sensor_energy_15min");

                entity.HasIndex(x => new { x.bucket_start, x.fk_sensor })
                    .HasDatabaseName("ix_sensor_energy_15min_bucket");

                entity.Property(x => x.bucket_start)
                    .HasColumnType("timestamp with time zone");

                entity.Property(x => x.first_reading_at)
                    .HasColumnType("timestamp with time zone");

                entity.Property(x => x.last_reading_at)
                    .HasColumnType("timestamp with time zone");
        ...
        public DbSet<tbl_dashboard_chart_aggregate> tbl_dashboard_chart_aggregate { get; set; }
        public DbSet<tbl_dashboard_suggestion> tbl_dashboard_suggestion { get; set; }
        public DbSet<tbl_energy_tariff_plan> tbl_energy_tariff_plan { get; set; }
        public DbSet<tbl_tariff_time_period> tbl_tariff_time_period { get; set; }

        public DbSet<tbl_sensor_energy_15min> tbl_sensor_energy_15min { get; set; }
        public DbSet<tbl_demand_management_setting> tbl_demand_management_setting { get; set; }
