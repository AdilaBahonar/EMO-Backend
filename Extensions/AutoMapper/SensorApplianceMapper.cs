    ...
    public class SensorApplianceMapper : Profile
    {
        ...
        public SensorApplianceMapper()
        {
            ...
            CreateMap<tbl_sensor_appliance, SensorApplianceResponseDTO>()
                ...
                .ForMember(d => d.isShiftable, opt => opt.MapFrom(src => src.appliance.is_shiftable))
                ...
                .ForMember(d => d.normalOperatingHours, opt => opt.MapFrom(src => src.appliance.normal_operating_hours))
                .ForMember(d => d.canAutoControl, opt => opt.MapFrom(src => src.appliance.can_auto_control))
                .ForMember(d => d.allowedShiftStartTime, opt => opt.MapFrom(src => src.appliance.allowed_shift_start_time))
                .ForMember(d => d.allowedShiftEndTime, opt => opt.MapFrom(src => src.appliance.allowed_shift_end_time))
                .ForMember(d => d.allowOptimizationSuggestions, opt => opt.MapFrom(src => src.appliance.allow_optimization_suggestions))
                .ForMember(d => d.minimumOnDurationMinutes, opt => opt.MapFrom(src => src.appliance.minimum_on_duration_minutes))
                .ForMember(d => d.minimumOffDurationMinutes, opt => opt.MapFrom(src => src.appliance.minimum_off_duration_minutes))
                .ForMember(d => d.remarks, opt => opt.MapFrom(src => src.remarks))
