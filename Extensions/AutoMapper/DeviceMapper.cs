        ...
        public DeviceMapper()
        {
            CreateMap<AddDeviceDTO, tbl_device>()
             .ForMember(d => d.device_name, opt => opt.MapFrom(src => src.deviceName))
              .ForMember(d => d.mac_address, opt => opt.MapFrom(src => src.deviceMacAddress))
            ...
            .ForMember(d => d.mac_address, opt => opt.MapFrom((src, dest) => otherServices.Check(src.deviceMacAddress) ? src.deviceMacAddress : dest.mac_address))
            ...
            CreateMap<tbl_device, DeviceResponseDTO>()
              ...
              .ForMember(d => d.deviceMacAddress, opt => opt.MapFrom(src => src.mac_address))
